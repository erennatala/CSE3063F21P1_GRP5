...
Welcome to ``Python_Project`` contributor's guide.
...
If you experience bugs or general issues with ``Python_Project``, please have a look
...
You can help improve ``Python_Project`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Python_Project`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Python_Project``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Python_Project python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Python_Project.git
    cd Python_Project
...
#. Install |pre-commit|_::
   ...
   ``Python_Project`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Python_Project
.. _issue tracker: https://github.com/<USERNAME>/Python_Project/issues
.. <-- end -->
